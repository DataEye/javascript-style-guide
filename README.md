...
## <a name="objects">对象</a>
  ...
  [更多信息](https://github.com/airbnb/javascript/issues/61)。
...
## <a name="commas">逗号</a>
  ...
  在 ES5 中已经澄清了 ([source](http://es5.github.io/#D))：
...
## <a name="type-casting--coercion">类型转换</a>
  ...
  - 如果因为某些原因 `parseInt` 成为你所做的事的瓶颈而需要使用位操作解决[性能问题](http://jsperf.com/coercion-vs-casting/3)时，
  留个注释说清楚原因和你的目的。
  ...
  （[source](http://es5.github.io/#x11.7)）。位操作处理大于 32 位的整数值时还会导致意料之外的行为。
  [讨论](https://github.com/airbnb/javascript/issues/109)。最大的 32 位整数是 2,147,483,647：
